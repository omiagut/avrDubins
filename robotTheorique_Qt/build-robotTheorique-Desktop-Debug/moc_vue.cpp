...
const QMetaObjectExtraData Vue::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Vue::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_Vue,
      qt_meta_data_Vue, &staticMetaObjectExtraData }
};
